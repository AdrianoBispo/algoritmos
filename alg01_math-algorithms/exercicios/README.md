...
- **Passo a passo:**
    ...
    3. Abordagem B (Matemática): Utilize a fórmula da Progressão Aritmética: $S = \frac{n(n+1)}{2}$. Esta abordagem é $O(1)$, muito mais eficiente para números grandes.
        
- **Exemplo:** _Entrada: `5`_ | _Saída: `15`_ (1+2+3+4+5 = 15).

### 2. Soma dos Quadrados dos Naturais

- **Descrição:** Calcular $1^2 + 2^2 + 3^2 + ... + n^2$. Útil para entender como o crescimento exponencial impacta somatórios.
        
- **Passo a passo:**
    1. Receba o valor limite $n$.
    2. Utilize um laço de repetição ou a fórmula fechada: $\frac{n(n+1)(2n+1)}{6}$.
    3. Certifique-se de tratar casos onde $n=0$ ou $n=1$.
        
- **Exemplo:** Entrada: `3` | Saída: `14` (1 + 4 + 9 = 14).
...
- **Passo a passo:**
    ...
    3. Cálculo: $a_n = a + (n-1) \times r$.
        
- **Exemplo:** Entrada: `a=2, r=3, n=5` | Saída: `14` (Série: 2, 5, 8, 11, **14**).
...
- **Passo a passo:**
    ...
    2. A lógica fundamental é: $a_n = a \times r^{(n-1)}$.
    3. Atenção: se r for grande, o valor de $a_n$ pode ultrapassar a capacidade de um inteiro padrão (overflow).
        
- **Exemplo:** Entrada: `a=2, r=2, n=4` | Saída: `16` (Série: 2, 4, 8, **16**).

### 5. Enésimo Número Triangular

- **Descrição:** Um número triangular $T_n$ conta objetos arranjados em um triângulo equilátero. É visualmente a soma de 1 até n.
        
- **Passo a passo:**
    1. Receba o nível n do triângulo.
    2. O cálculo é idêntico à soma dos naturais: $\frac{n(n+1)}{2}$.
        
- **Exemplo:** Entrada: `4` | Saída: `10` (Visual: uma base de 4, sobreposta por 3, 2 e 1).

### 6. Soma das Somas dos Números Naturais

- **Descrição:** Calcular o "somatório do somatório". Ou seja: $S = S_1 + S_2 + ... + S_n$, onde $S_i$ é a soma de 1 até i.
...
- **Exemplo:** Entrada: `3` | Saída: `10` (Somas parciais: $S_1 = 1$, $S_2 = 3$, $S_3 = 6$ → 1+3+6 = 10).
...
- **Passo a passo:**
    ...
    3. Dica: Para $N = 0$, a contagem deve ser 1. Outra forma é usar a função logarítmica: $\lfloor \log_{10}(N) \rfloor + 1$.
        
- **Exemplo:** Entrada: `1234` | Saída: `4`.
...
- **Passo a passo:**
    1. Receba N.
    2. Extraia o último dígito usando o operador de resto: `N % 10`.
    3. Some esse dígito ao totalizador e atualize N para `N / 10`.
...
- **Passo a passo:**
    1. Inicialize `reverso = 0`.
    2. Em um laço: pegue o último dígito de N, multiplique o `reverso` atual por 10 e some o dígito extraído.
    3. Reduza N dividindo por 10.
        
- **Exemplo:** Entrada: `456` | Saída: `654`.

### 10. K-ésimo Dígito em $a^b$
...
- **Passo a passo:**
    ...
    3. Aplique `% 10` para isolar o dígito.
        
- **Exemplo:** Entrada: `a=3, b=3, k=1` | Saída: `7` ($3^3 = 27$; o 1º dígito é 7).
...
- **Passo a passo:**
    ...
    3. Compare se `original == reverso`. Se sim, retorne verdadeiro.
        
- **Exemplo:** Entrada: `121` | Saída: `True`; Entrada: `123` | Saída: `False`.
...
- **Passo a passo:**
    ...
    2. Use a propriedade: $\text{MMC}(a,b) = \frac{|a \times b|}{\text{MDC}(a,b)}$.
        
- **Exemplo:** Entrada: `15, 20` | Saída: `60`.
...
- **Passo a passo:**
    ...
    2. Ajuste os numeradores: $(a \times d) + (c \times b)$.
...
- **Exemplo:** Entrada: `1/2 + 1/4` | Saída: `3/4` (após simplificar `6/8`).
...
- **Exemplo:** Entrada: `8, 15` | Saída: `True` (MDC é 1).
...
- **Passo a passo:**
    1. Inicialize `resultado = 1`.
    2. Multiplique pelo índice de um laço que vai de 2 até n.
    3. Considere que $0! = 1$.
        
- **Exemplo:** Entrada: `5` | Saída: `120` (1×2×3×4×5).
...
- **Exemplo:** Entrada: `[12, 18, 24]` | Saída: `6`.
...
- **Exemplo:** Entrada: `[2, 7, 3]` | Saída: `42`.
...
- **Exemplo:** Entrada: `n=6` | Saída: `4` (Série: 1, 1, 1, 2, 2, 3, **4**).

### 20. Contagem de Pares Cúbicos

- **Descrição:** Descobrir quantos pares de números inteiros positivos (a,b) satisfazem a equação $a^3 + b^3 = n$.
        
- **Passo a passo:**
    1. Itere o valor de a de 1 até $\sqrt[3]{n}$.
    2. Para cada a, calcule o valor que b deveria ter: $b = \sqrt[3]{n - a^3}$.
    3. Se b for um número inteiro positivo, incremente o contador.
        
- **Exemplo:** Entrada: `9` | Saída: `1` (Par: $1^3 + 2^3 = 1 + 8 = 9$).
...
- **Passo a passo:**
    ...
    2. Use uma variável `termo` que começa com 2.
    3. Em um laço de 1 a n: adicione `termo` à `soma` total e atualize o `termo` fazendo `(termo * 10) + 2`.
        
- **Exemplo:** Entrada: `3` | Saída: `246` (2 + 22 + 222).
...
- **Exemplo:** Entrada: `2` | Saída: `10` ($1^2 + 3^2$).
...
- **Passo a passo:**
    1. Observe que os termos seguem a fórmula $n^2 + n^3$.
    2. Calcule o resultado para o n fornecido.
        
- **Exemplo:** Entrada: `3` | Saída: `36` ($3^2 + 3^3 = 9 + 27$).
...
- **Exemplo:** Entrada: `98` | Saída: `8` (9+8=17 → 1+7=8).
...
- **Exemplo:** Entrada: `3` | Saída: `4` (Série: 2, 1, 3, **4**).

### 28. Verificar Potência

- **Descrição:** Checar se um número y pode ser escrito como $x^k$.
...
- **Exemplo:** Entrada: `x=2, y=16` | Saída: `True` ($2^4 = 16$).
...
- **Passo a passo:**
    ...
    2. Verifique se $\sqrt{n}$ é um número inteiro.
    3. Se sim, verifique se essa raiz é um número primo.
        
- **Exemplo:** Entrada: `49` | Saída: `True` (Divisores: 1, 7, 49).

### 30. Raiz Quadrada Inteira

- **Descrição:** Calcular o maior inteiro x tal que $x^2 \leq n$. Não utilize funções prontas de raiz.
        
- **Passo a passo:**
    1. Use busca binária: chute um valor entre 0 e n.
    2. Se $\text{meio}^2$ for maior que n, procure na metade inferior; caso contrário, salve o valor e procure na metade superior.
        
- **Exemplo:** Entrada: `11` | Saída: `3`.
...
- **Passo a passo:**
    1. Use a fórmula: $\frac{n!}{r! \times (n-r)!}$.
    2. Dica de eficiência: nCr = nC(n−r). Calcule apenas o menor lado.
        
- **Exemplo:** Entrada: `n=5, r=2` | Saída: `10`.
...
- **Exemplo:** Entrada: `3` | Saída: `[[1], [1,1], [1,2,1]]`.
...
- **Passo a passo:**
    ...
    2. Calcule os termos usando a relação: $\text{termo}(k) = \text{termo}(k-1) \times \frac{(n-k+1)}{k}$.
        
- **Exemplo:** Entrada: `3` | Saída: `[1, 3, 3, 1]`.
...
- **Exemplo:** Entrada: `153` | Saída: `True` ($1^3 + 5^3 + 3^3 = 1 + 125 + 27 = 153$).
...
- **Passo a passo:**
    1. Se for 2×2: $(a \times d) - (b \times c)$.
    2. Se for 3×3: Siga a regra de Sarrus ou expansão por cofatores.
        
- **Exemplo:** Entrada: `[[1,2],[3,4]]` | Saída: `-2`.

### 36. Exponenciação Modular

- **Descrição:** Calcular $(a^b) \% m$. Essencial em criptografia RSA.
        
- **Passo a passo:**
    1. Não tente elevar a a b diretamente se b for grande.
    2. Use o algoritmo de **Exponenciação Binária**: se b é par, $a^b = (a^{b/2})^2$. Se ímpar, $a^b = a \times a^{b-1}$.
    3. Aplique `% m` em cada multiplicação intermediária.
        
- **Exemplo:** Entrada: `a=2, b=10, m=1000` | Saída: `24` ($1024 \% 1000$).
...
- **Passo a passo:**
    ...
    2. Verifique se $\text{raiz} \times \text{raiz} = n$.
        
- **Exemplo:** Entrada: `25` | Saída: `True`.
...
- **Exemplo:** Entrada: `121, div por 11` | Saída: `True`.
...
- **Passo a passo:**
    1. Calcule $g = \text{MDC}(a,b)$.
    2. Se $c \% g \neq 0$, a equação não possui soluções inteiras.
        
- **Exemplo:** Entrada: `3x + 6y = 9` | Saída: `True`.

### 45. Função Totiente de Euler (φ)
...
- **Passo a passo:**
    ...
    2. Otimização: $\varphi(n) = n \times \prod(1 - \frac{1}{p})$ para cada fator primo p de n.
        
- **Exemplo:** Entrada: `9` | Saída: `6` (1, 2, 4, 5, 7, 8).
...
- **Exemplo:** Entrada: `10` | Saída: `[2, 3, 5, 7]`.
...
- **Passo a passo:**
    1. Percorra apenas até $\sqrt{n}$. Se i divide n, então n÷i também divide.
    2. Guarde ambos os resultados para evitar percorrer a lista inteira.
        
- **Exemplo:** Entrada: `12` | Saída: `[1, 2, 3, 4, 6, 12]`.

### 48. Fatoração em Primos

- **Descrição:** Expressar um número como produto de seus componentes primos ($12 = 2^2 \times 3$).
        
- **Passo a passo:**
    1. Divida por 2 enquanto for possível.
    2. Depois, tente dividir por números ímpares começando de 3 até $\sqrt{n}$.
        
- **Exemplo:** Entrada: `12` | Saída: `2, 2, 3`.
...
- **Passo a passo:**
    1. Execute a fatoração e mantenha uma variável `maior` que é atualizada a cada divisão bem-sucedida.
        
- **Exemplo:** Entrada: `15` | Saída: `5`.
...
- **Exemplo:** Entrada: `20` | Saída: `2432902008176640000`.

### 51. Maior Potência Divisível em Fatoriais

- **Descrição:** Dado n! e um número k, qual o maior expoente x tal que $k^x$ divide n!?
        
- **Passo a passo:**
    1. Se k for primo, use a fórmula de Legendre: $\lfloor \frac{n}{k} \rfloor + \lfloor \frac{n}{k^2} \rfloor + ...$
    2. Se k for composto, analise seus fatores primos separadamente.
        
- **Exemplo:** Entrada: `n=5, k=2` | Saída: `3`.
...
- **Exemplo:** Entrada: `5` | Saída: `2` (120 → 2).
...
- **Passo a passo:**
    1. Para um conjunto de n elementos, existem $2^n$ subconjuntos.
    2. Use um contador binário de 0 a $2^n - 1$. Se o bit j estiver ligado no contador, inclua o elemento j da lista no subconjunto atual.
        
- **Exemplo:** Entrada: `[1, 2]` | Saída: `[[], [1], [2], [1, 2]]`.

### 54. Somar Dois Polinômios

- **Descrição:** Representar e somar expressões como $2x^2 + 3x + 5$.
...
- **Exemplo:** Entrada: `[1, 2] + [3, 4, 5]` | Saída: `[4, 6, 5]`.
...
- **Exemplo:** Entrada: `ABC` | Saída: `ABC, ACB, BAC, BCA, CAB, CBA`.
...
- **Passo a passo:**
    ...
    2. Para todo a tal que MDC(a,n) = 1, verifique se $a^{n-1} \% n = 1$.
        
- **Exemplo:** Entrada: `561` | Saída: `True`.
...
- **Exemplo:** Entrada: `3` | Saída: `7` passos (3, 10, 5, 16, 8, 4, 2, 1).
...
- **Passo a passo:**
    1. Note que os pares seguem a regra $\text{EF}(n) = 4 \times \text{EF}(n-1) + \text{EF}(n-2)$.
    2. Inicie com 2 e 8.
        
- **Exemplo:** Entrada: `3` | Saída: `34` (2, 8, 34, 144...).
...
- **Passo a passo:**
    ...
    2. Aplique `% 100` em cada soma do laço para manter os números pequenos.
        
- **Exemplo:** Entrada: `10` | Saída: `55`.
...
- **Exemplo:** Entrada: `n=7, k=3` | Saída: `4` (assumindo índice começando em 1).
...
- **Exemplo:** Entrada: `jarros 3L e 5L, meta 4L` | Saída: `True`.
...
- **Exemplo:** Entrada: `12, k=3` | Saída: `3` (Fatores: 2, 2, 3).

### 66. N-ésima Raiz

- **Descrição:** Calcular $\sqrt[m]{n}$ com alta precisão.
        
- **Passo a passo:**
    1. Use o **Método de Newton**: $x_{\text{novo}} = \frac{1}{m} \times ((m-1) \times x_{\text{atual}} + \frac{n}{x_{\text{atual}}^{m-1}})$.
    2. Repita até que a diferença entre o chute anterior e o novo seja mínima.
        
- **Exemplo:** Entrada: `n=3, m=27` | Saída: `3`.
...
- **Passo a passo:**
    ...
    2. A relação é: $\text{DP}[i][j] = \text{DP}[i-1][j-1] + \text{DP}[i][j-1] + 1$.
        
- **Exemplo:** Entrada: `2 ovos, 10 andares` | Saída: `4`.
